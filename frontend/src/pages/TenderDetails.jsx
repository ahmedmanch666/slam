                    ...
                    <tbody>
                        {competitors.length === 0 ? (
                            ...
                            <tr key={comp.id} className={`border-b ${comp.is_winner ? 'bg-green-50' : 'bg-white'}`}>
                                ...
                                <td className="px-6 py-4 font-bold">{Number(comp.price).toLocaleString()} ج.م</td>
                    ...
                    <tbody>
                        {invoices.length === 0 ? (
                            ...
                            <tr key={inv.id} className="bg-white border-b hover:bg-slate-50">
                                ...
                                <td className="px-6 py-4 font-bold">{(Number(inv.amount) + Number(inv.vat_amount)).toLocaleString()} ج.م</td>
                                <td className="px-6 py-4">
                ...
                <div className="section mb-6">
                    ...
                    <table className="w-full text-sm">
                        <tbody>
                            ...
                            <tr className="border-b"><td className="py-2 font-semibold">القيمة التقديرية</td><td>{Number(tender.value || 0).toLocaleString()} ج.م</td></tr>
                ...
                <div className="section mb-6">
                            ...
                            <tbody>
                                {competitors.map(comp => (
                                    <tr key={comp.id} className={comp.is_winner ? 'bg-green-50' : ''}>
                                        ...
                                        <td className="p-2 border">{Number(comp.price).toLocaleString()} ج.م</td>
                    ...
                    {winner && (
                        <div className="mt-3 p-3 bg-green-100 rounded-lg text-green-800">
                            ✅ <strong>الفائز بالمناقصة:</strong> {winner.name} بسعر {Number(winner.price).toLocaleString()} ج.م
                        </div>
                    )}
                </div>
                ...
                <div className="section mb-6">
                    ...
                    <table className="w-full text-sm border">
                        <tbody>
                            ...
                            <tr className="border-b"><td className="p-2 font-semibold">إجمالي المبالغ (بدون ضريبة)</td><td>{totalInvoices.toLocaleString()} ج.م</td></tr>
                            <tr className="border-b"><td className="p-2 font-semibold">إجمالي الضريبة</td><td className="text-red-600">{totalVat.toLocaleString()} ج.م</td></tr>
                            <tr className="bg-indigo-50"><td className="p-2 font-bold">الإجمالي الكلي</td><td className="font-bold text-indigo-700">{totalWithVat.toLocaleString()} ج.م</td></tr>
                        </tbody>
                    </table>
                </div>
